...
def main(args):
    ...
    try:
        ...
        lookup = {
            "cif_2016_6_dataset": (15, 6),
            "cif_2016_12_dataset": (15, 12),
            "nn5_daily_dataset": (9 ),
            ...
            "saugeen_river_flow_dataset": (9    , 30),
            "sunspot_dataset": (9    , 30, True),
            ...
            "kdd_cup_dataset": (210    , 168),
            "melbourne_pedestrian_counts_dataset": (210    , 24, True),
            "bitcoin_dataset": (9    , 30),
            "vehicle_trips_dataset": (9    , 30, True),
            "aus_elecdemand_dataset": (420    , 336),
            "rideshare_dataset": (210    , 168),
            "temperature_rain_dataset": (9    , 30)
        }
        ...
        with open(os.path.join(output_dir, f'error.json'), 'a') as f:
            f.write(str(e))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset',    default='m4_weekly_dataset')
